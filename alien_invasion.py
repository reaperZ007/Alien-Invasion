...
class AlienInvasion:
    ...
    def _check_play_button(self,mouse_pos):
           ...
           if button_clicked and not self.stats.game_active:
                  ...
                  # get rid of any remaing alien an bullet
                  self.aliens.empty()
                  self.bullets.empty()
    ...
    def _create_fleet(self):
           ...
           # make an alien and find the number of alien in a row
           ...
           # Determin the no. of rows of aliens that fit on the screen
           ship_height = self.ship.rect.height
           available_space_y = (self.settings.screen_hieght - (3 * alien_height) -  ship_height)
    ...
    def _create_alien(self,alien_number,row_number):
           """Create an alien and place in its row"""
           alien = Alien(self)
           alien_width,alien_height = alien.rect.size
    ...
    def _change_fleet_direction(self):
           """Drop the entire fleet and change the fleett direction"""
           for alien in self.aliens.sprites():
